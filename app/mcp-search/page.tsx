...
type CategoryGroup = {
  ...
  label: string
  labelFr: string
  categories: { id: string; label: string; labelFr: string; count: number }[]
}

type ToolItem = { id: string; label: string; count: number }
...
export default function McpSearchPage() {
  ...
  const [totalMcps, setTotalMcps] = useState(0)
  ...
  // BROWSE MODE — category + tool (either can be null = "All")
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1 min-w-0">
            {/* Results header — only in browse mode */}
            {isBrowse && !loading && (
