...
// Scenes
const HERO_DURATION = 4 * FPS;
const FILTERS_DURATION = 5 * FPS;
const QUIZ_DURATION = 9 * FPS;
const OUTRO_DURATION = 3 * FPS;

export const DURATION_IN_FRAMES =
  HERO_DURATION + QUIZ_DURATION + FILTERS_DURATION + OUTRO_DURATION;
      ...
      >
        ...
        <h1
          style={{
            ...
            textAlign: 'center',
            lineHeight: 1,
            background: 'linear-gradient(90deg, #fb923c, #fcd34d, #fb923c)',
        ...
        >
          Interactive quizzes to level up every week
        </p>
        <div
          style={{
            marginTop: 50,
    ...
    >
      <div
        style={{
          ...
          borderRadius: 24,
          padding: 50,
          transform: `translateY(${Math.max(0, (1 - cardY)) * 60}px)`,
          opacity: Math.min(1, cardY),
        }}
      >
        <h2 style={{ fontSize: 52, margin: 0, lineHeight: 1.1 }}>
        ...
        >
          Pick the categories and difficulty that match your level
        </p>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 12,
                    fontSize: 28,
                    border: `1px solid ${selected ? '#fb923c' : '#3f3f46'}`,
                    background: selected
...
const QuizScene: React.FC = () => {
  ...
  const REVEAL_START = 4 * FPS;
  const EXPLAIN_START = 5.5 * FPS;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 style={{ fontSize: 52, margin: 0, lineHeight: 1.2 }}>
          Which command resumes the last Claude Code session?
        </h2>
        ...
        >
          {options.map((opt, i) => {
            ...
            return (
              ...
              >
                <span style={{ color: textColor, marginRight: 16 }}>
        ...
        {explainProgress > 0 && (
          ...
          >
            ...
            — it resumes the last active conversation from the current directory.
          </div>
        )}
      </div>
    </AbsoluteFill>
  ...
  return (
    <AbsoluteFill>
      ...
      >
        ...
        >
          Comment "Claude" and get the link to the webapp.
        </p>
      </AbsoluteFill>
    </AbsoluteFill>
  );
...
export const DemoVideoStoriesEN: React.FC = () => {
  return (
    <AbsoluteFill>
